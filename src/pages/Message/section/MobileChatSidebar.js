...
class MobileChatSidebar extends Component {
    state = {
        activeItem: "1"
      }
                ...
                <div className="contacts">
                    ...
                    {this.state.activeItem === "1" && (
                        <div className="list-group" id="contacts" role="tablist">
                            <Link to="/message/details" className="filterMembers all online contact show" data-toggle="list">
                    ...
                    {this.state.activeItem === "3" && (
                        <div className="list-group" id="contacts" role="tablist">
                            <Link href="/" className="filterMembers all online contact show" data-toggle="list">
                                <img className="avatar-md" src={feMaleUser} data-toggle="tooltip" data-placement="top" title="" alt="avatar" data-original-title="Janette" />
                                <div className="status">
                                </div>
                                <div className="data">
